...
map.getView().fit([4376350.519655, -3005013.348717, 6267144.797592, -1267171.042924], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">LOCALISATION WS</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (22 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'PROJET SOFF ACTIVITIES';
            }
